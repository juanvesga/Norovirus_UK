collect_function <- function(info) {
  ...
  state = data.frame(
    ...
    # reported_gi3  = info$bystrain_prop[1,],# info$reported_day_gi3,
    # reported_gi   = info$bystrain_prop[2,],#info$reported_day_gi,
    # reported_gii4 = info$bystrain_prop[3,],#info$reported_day_gii4,
    # reported_gii  = info$bystrain_prop[4,],#info$reported_day_gii,
    
    reported_gi3  = info$cumulative_cases_strain[1,],# info$reported_day_gi3,
    reported_gi   = info$cumulative_cases_strain[2,],#info$reported_day_gi,
    reported_gii4 = info$cumulative_cases_strain[3,],#info$reported_day_gii4,
    reported_gii  = info$cumulative_cases_strain[4,],#info$reported_day_gii,
    
    # reported_gi3  =  info$reported_day_gi3,
    # reported_gi   = info$reported_day_gi,
    # reported_gii4 = info$reported_day_gii4,
    # reported_gii  = info$reported_day_gii,
    # 
