...
noro_model <- odin({
  ...
  beta_3 <- exp(log_beta_3) * transm_emerg
  beta_1 <- exp(log_beta_3) * factor_beta_1
  beta_2 <- exp(log_beta_3) * factor_beta_2
  beta_4 <- exp(log_beta_3) * factor_beta_4
