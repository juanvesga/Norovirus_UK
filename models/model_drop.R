...
noro_model <- odin({
  ...
  reported_fac_long[9]<-1/repfac_15
      ...
      (infections_day_gi3[i]+
        ...
        if(i==2) 
          (infections_day_gi3[i]+
            ...
            if(i==3) 
              (infections_day_gi3[i]+
                 sum(n_E_I[9,1]) * reported_fac[i] +
                 sum(n_E2_I2[9,1]) * reported_fac[i] +
                 sum(n_E3_I3[9,1]) * reported_fac[i] +
                 sum(n_E4_I4[9,1]) * reported_fac[i] +
                 sum(n_E23_I23[9,1]) * reported_fac[i] +
                 sum(n_E24_I24[9,1]) * reported_fac[i] +
                 sum(n_E34_I34[9,1]) * reported_fac[i] +
                 sum(n_E4rd_I4rd[9,1]) * reported_fac[i]  
              ) else
                (infections_day_gi3[i]+
                   sum(n_E_I[10,1]) * reported_fac[i] +
                   sum(n_E2_I2[10,1]) * reported_fac[i] +
                   sum(n_E3_I3[10,1]) * reported_fac[i] +
                   sum(n_E4_I4[10,1]) * reported_fac[i] +
                   sum(n_E23_I23[10,1]) * reported_fac[i] +
                   sum(n_E24_I24[10,1]) * reported_fac[i] +
                   sum(n_E34_I34[10,1]) * reported_fac[i] +
                   sum(n_E4rd_I4rd[10,1]) * reported_fac[i])
      ...
      (infections_day_gi[i]+
        ...
        if(i==2) 
          (infections_day_gi[i]+
            ...
            if(i==3) 
              (infections_day_gi[i]+
                 sum(n_E_I[9,2]) * reported_fac[i] +
                 sum(n_E1_I1[9,1]) * reported_fac[i] +
                 sum(n_E3_I3[9,2]) * reported_fac[i] +
                 sum(n_E4_I4[9,2]) * reported_fac[i] +
                 sum(n_E13_I13[9,1]) * reported_fac[i] +
                 sum(n_E14_I14[9,1]) * reported_fac[i] +
                 sum(n_E34_I34[9,2]) * reported_fac[i] +
                 sum(n_E4rd_I4rd[9,2]) * reported_fac[i] 
              ) else
                (infections_day_gi[i]+
                   sum(n_E_I[10,2]) * reported_fac[i] +
                   sum(n_E1_I1[10,1]) * reported_fac[i] +
                   sum(n_E3_I3[10,2]) * reported_fac[i] +
                   sum(n_E4_I4[10,2]) * reported_fac[i] +
                   sum(n_E13_I13[10,1]) * reported_fac[i] +
                   sum(n_E14_I14[10,1]) * reported_fac[i] +
                   sum(n_E34_I34[10,2]) * reported_fac[i] +
                   sum(n_E4rd_I4rd[10,2]) * reported_fac[i] )
      ...
      (infections_day_gii4[i]+
        ...
        if(i==2) 
          (infections_day_gii4[i]+
            ...
            if(i==3) 
              (infections_day_gii4[i]+
                 sum(n_E_I[9,3]) * reported_fac[i] +
                 sum(n_E1_I1[9,2]) * reported_fac[i] +
                 sum(n_E2_I2[9,2]) * reported_fac[i] +
                 sum(n_E4_I4[9,3]) * reported_fac[i] +
                 sum(n_E12_I12[9,1]) * reported_fac[i] +
                 sum(n_E14_I14[9,2]) * reported_fac[i] +
                 sum(n_E24_I24[9,2]) * reported_fac[i] +
                 sum(n_E4rd_I4rd[9,3]) * reported_fac[i]  
              ) else
                (infections_day_gii4[i]+
                   sum(n_E_I[10,3]) * reported_fac[i] +
                   sum(n_E1_I1[10,2]) * reported_fac[i] +
                   sum(n_E2_I2[10,2]) * reported_fac[i] +
                   sum(n_E4_I4[10,3]) * reported_fac[i] +
                   sum(n_E12_I12[10,1]) * reported_fac[i] +
                   sum(n_E14_I14[10,2]) * reported_fac[i] +
                   sum(n_E24_I24[10,2]) * reported_fac[i] +
                   sum(n_E4rd_I4rd[10,3]) * reported_fac[i])
      ...
      (infections_day_gii[i]+
        ...
        if(i==2) 
          (infections_day_gii[i]+
            ...
            if(i==3) 
              (infections_day_gii[i]+
                 sum(n_E_I[9,4]) * reported_fac[i] +
                 sum(n_E1_I1[9,3]) * reported_fac[i] +
                 sum(n_E2_I2[9,3]) * reported_fac[i] +
                 sum(n_E3_I3[9,3]) * reported_fac[i] +
                 sum(n_E12_I12[9,2]) * reported_fac[i] +
                 sum(n_E13_I13[9,2]) * reported_fac[i] +
                 sum(n_E23_I23[9,2]) * reported_fac[i] +
                 sum(n_E4rd_I4rd[9,4]) * reported_fac[i]   
              ) else
                (infections_day_gii[i]+
                   sum(n_E_I[10,4]) * reported_fac[i] +
                   sum(n_E1_I1[10,3]) * reported_fac[i] +
                   sum(n_E2_I2[10,3]) * reported_fac[i] +
                   sum(n_E3_I3[10,3]) * reported_fac[i] +
                   sum(n_E12_I12[10,2]) * reported_fac[i] +
                   sum(n_E13_I13[10,2]) * reported_fac[i] +
                   sum(n_E23_I23[10,2]) * reported_fac[i] +
                   sum(n_E4rd_I4rd[10,4]) * reported_fac[i]  )
  ...
  update(reported_day_gi3) <-  
    (sum(n_E_I[1:4,1])* reported_geno[1] +
       ...
       sum(n_E_I[9,1])* reported_geno[3] +
       sum(n_E2_I2[9,1])* reported_geno[3] +
       sum(n_E3_I3[9,1])* reported_geno[3] +
       sum(n_E4_I4[9,1])* reported_geno[3] +
       sum(n_E23_I23[9,1])* reported_geno[3] +
       sum(n_E24_I24[9,1])* reported_geno[3] +
       sum(n_E34_I34[9,1])* reported_geno[3] +
       sum(n_E4rd_I4rd[9,1])* reported_geno[3] +
       sum(n_E_I[10,1])* reported_geno[4] +
       sum(n_E2_I2[10,1])* reported_geno[4] +
       sum(n_E3_I3[10,1])* reported_geno[4] +
       sum(n_E4_I4[10,1])* reported_geno[4] +
       sum(n_E23_I23[10,1])* reported_geno[4] +
       sum(n_E24_I24[10,1])* reported_geno[4] +
       sum(n_E34_I34[10,1])* reported_geno[4] +
       sum(n_E4rd_I4rd[10,1])* reported_geno[4] ) 
  
  
  
  update(reported_day_gi) <-  
    (sum(n_E_I[1:4,2] )* reported_geno[1] +
       ...
       sum(n_E_I[9,2] )* reported_geno[3] +
       sum(n_E1_I1[9,1])* reported_geno[3]+
       sum(n_E3_I3[9,2])* reported_geno[3] +
       sum(n_E4_I4[9,2])* reported_geno[3] +
       sum(n_E13_I13[9,1])* reported_geno[3] +
       sum(n_E14_I14[9,1])* reported_geno[3] +
       sum(n_E34_I34[9,2])* reported_geno[3] +
       sum(n_E4rd_I4rd[9,2])* reported_geno[3]+
       sum(n_E_I[10,2] )* reported_geno[4] +
       sum(n_E1_I1[10,1])* reported_geno[4]+
       sum(n_E3_I3[10,2])* reported_geno[4] +
       sum(n_E4_I4[10,2])* reported_geno[4] +
       sum(n_E13_I13[10,1])* reported_geno[4] +
       sum(n_E14_I14[10,1])* reported_geno[4] +
       sum(n_E34_I34[10,2])* reported_geno[4] +
       sum(n_E4rd_I4rd[10,2])* reported_geno[4] ) 
  
  
  
  update(reported_day_gii4) <-  
    (sum(n_E_I[1:4,3])* reported_geno[1] +
       ...
       sum(n_E_I[9,3])* reported_geno[3] +
       sum(n_E1_I1[9,2])* reported_geno[3] +
       sum(n_E2_I2[9,2])* reported_geno[3] +
       sum(n_E4_I4[9,3])* reported_geno[3] +
       sum(n_E12_I12[9,1])* reported_geno[3] +
       sum(n_E14_I14[9,2])* reported_geno[3] +
       sum(n_E24_I24[9,2])* reported_geno[3] +
       sum(n_E4rd_I4rd[9,3])* reported_geno[3]+
       sum(n_E_I[10,3])* reported_geno[4] +
       sum(n_E1_I1[10,2])* reported_geno[4] +
       sum(n_E2_I2[10,2])* reported_geno[4] +
       sum(n_E4_I4[10,3])* reported_geno[4] +
       sum(n_E12_I12[10,1])* reported_geno[4] +
       sum(n_E14_I14[10,2])* reported_geno[4] +
       sum(n_E24_I24[10,2])* reported_geno[4] +
       sum(n_E4rd_I4rd[10,3])* reported_geno[4]) 
  
  
  
  update(reported_day_gii) <-  
    (sum(n_E_I[1:4,4])* reported_geno[1] +
       ...
       sum(n_E_I[9,4])* reported_geno[3] +
       sum(n_E1_I1[9,3])* reported_geno[3] +
       sum(n_E2_I2[9,3])* reported_geno[3] +
       sum(n_E3_I3[9,3])* reported_geno[3] +
       sum(n_E12_I12[9,2])* reported_geno[3] +
       sum(n_E13_I13[9,2])* reported_geno[3] +
       sum(n_E23_I23[9,2])* reported_geno[3] +
       sum(n_E4rd_I4rd[9,4])* reported_geno[3] +
       sum(n_E_I[10,4])* reported_geno[4] +
       sum(n_E1_I1[10,3])* reported_geno[4] +
       sum(n_E2_I2[10,3])* reported_geno[4] +
       sum(n_E3_I3[10,3])* reported_geno[4] +
       sum(n_E12_I12[10,2])* reported_geno[4] +
       sum(n_E13_I13[10,2])* reported_geno[4] +
       sum(n_E23_I23[10,2])* reported_geno[4] +
       sum(n_E4rd_I4rd[10,4])* reported_geno[4]) 
 ...
 # browser(phase = "update", when = time ==20635)
  
  #print("cumulative_cases_strain[3]: {cumulative_cases_strain[3]}", when = time > 21358 && time < 21400)
...
# Note the -20 is to rescale the parameters and allow calibration pof negative values of lag with a log transformation
  ...
  # Cros  protection matrix
    ...
    if(j==2) 1-crossp_GI else 1 ) else if(i==2)(
      if(j==1) 1-crossp_GI else 1) else if(i==3)(
        if(j==4) 1-crossp_GII else 1) else (
          if(j==3) 1-crossp_GII else 1)
  
  dim(cross_map)<-c(N_strain,N_strain)
  
lambda_cross[,,]  <- lambda[i, k] * cross_map[j, k] 
dim(lambda_cross)<-c(N_age,N_strain,N_strain)
...
n_muR4rd[, ] <- Binomial(R4rd[i, j]-n_ageoR4rd[i, j] , p_mu[i])
 ...
 n_ageiG[] <- if (i > 1) n_ageoG[max(1, i-1)] else 0.0
n_ageiM[] <- if (i > 1) n_ageoM[max(1, i-1)] else 0.0
n_ageiS[] <- if (i > 1) n_ageoS[max(1, i-1)] else 0.0
n_ageiE[,] <- if (i>1) n_ageoE[max(1, i-1),j] else 0.0
n_ageiI[,] <- if (i>1) n_ageoI[max(1, i-1),j] else 0.0
n_ageiA[,] <- if (i>1) n_ageoA[max(1, i-1),j] else 0.0
n_ageiR[,] <- if (i>1) n_ageoR[max(1, i-1),j] else 0.0
  n_ageiE1[,] <- if (i>1) n_ageoE1[max(1,i-1),j] else 0
  n_ageiI1[,] <- if (i>1) n_ageoI1[max(1,i-1),j] else 0
  n_ageiA1[,] <- if (i>1) n_ageoA1[max(1,i-1),j] else 0
  n_ageiR1[,] <- if (i>1) n_ageoR1[max(1,i-1),j] else 0
  n_ageiE2[,] <- if (i>1) n_ageoE2[max(1,i-1),j] else 0
  n_ageiI2[,] <- if (i>1) n_ageoI2[max(1,i-1),j] else 0
  n_ageiA2[,] <- if (i>1) n_ageoA2[max(1,i-1),j] else 0
  n_ageiR2[,] <- if (i>1) n_ageoR2[max(1,i-1),j] else 0
  n_ageiE3[,] <- if (i>1) n_ageoE3[max(1,i-1),j] else 0
  n_ageiI3[,] <- if (i>1) n_ageoI3[max(1,i-1),j] else 0
  n_ageiA3[,] <- if (i>1) n_ageoA3[max(1,i-1),j] else 0
  n_ageiR3[,] <- if (i>1) n_ageoR3[max(1,i-1),j] else 0
  n_ageiE4[,] <- if (i>1) n_ageoE4[max(1,i-1),j] else 0
  n_ageiI4[,] <- if (i>1) n_ageoI4[max(1,i-1),j] else 0
  n_ageiA4[,] <- if (i>1) n_ageoA4[max(1,i-1),j] else 0
  n_ageiR4[,] <- if (i>1) n_ageoR4[max(1,i-1),j] else 0
  n_ageiE12[,] <- if (i>1) n_ageoE12[max(1,i-1),j] else 0
  n_ageiI12[,] <- if (i>1) n_ageoI12[max(1,i-1),j] else 0
  n_ageiA12[,] <- if (i>1) n_ageoA12[max(1,i-1),j] else 0
  n_ageiR12[,] <- if (i>1) n_ageoR12[max(1,i-1),j] else 0
  n_ageiE13[,] <- if (i>1) n_ageoE13[max(1,i-1),j] else 0
  n_ageiI13[,] <- if (i>1) n_ageoI13[max(1,i-1),j] else 0
  n_ageiA13[,] <- if (i>1) n_ageoA13[max(1,i-1),j] else 0
  n_ageiR13[,] <- if (i>1) n_ageoR13[max(1,i-1),j] else 0
  n_ageiE14[,] <- if (i>1) n_ageoE14[max(1,i-1),j] else 0
  n_ageiI14[,] <- if (i>1) n_ageoI14[max(1,i-1),j] else 0
  n_ageiA14[,] <- if (i>1) n_ageoA14[max(1,i-1),j] else 0
  n_ageiR14[,] <- if (i>1) n_ageoR14[max(1,i-1),j] else 0
  n_ageiE23[,] <- if (i>1) n_ageoE23[max(1,i-1),j] else 0
  n_ageiI23[,] <- if (i>1) n_ageoI23[max(1,i-1),j] else 0
  n_ageiA23[,] <- if (i>1) n_ageoA23[max(1,i-1),j] else 0
  n_ageiR23[,] <- if (i>1) n_ageoR23[max(1,i-1),j] else 0
  n_ageiE24[,] <- if (i>1) n_ageoE24[max(1,i-1),j] else 0
  n_ageiI24[,] <- if (i>1) n_ageoI24[max(1,i-1),j] else 0
  n_ageiA24[,] <- if (i>1) n_ageoA24[max(1,i-1),j] else 0
  n_ageiR24[,] <- if (i>1) n_ageoR24[max(1,i-1),j] else 0
  n_ageiE34[,] <- if (i>1) n_ageoE34[max(1,i-1),j] else 0
  n_ageiI34[,] <- if (i>1) n_ageoI34[max(1,i-1),j] else 0
  n_ageiA34[,] <- if (i>1) n_ageoA34[max(1,i-1),j] else 0
  n_ageiR34[,] <- if (i>1) n_ageoR34[max(1,i-1),j] else 0
  n_ageiE4rd[,] <- if (i>1) n_ageoE4rd[max(1,i-1),j] else 0
  n_ageiI4rd[,] <- if (i>1) n_ageoI4rd[max(1,i-1),j] else 0
  n_ageiA4rd[,] <- if (i>1) n_ageoA4rd[max(1,i-1),j] else 0
  n_ageiR4rd[,] <- if (i>1) n_ageoR4rd[max(1,i-1),j] else 0
...
#        min(max(lambda[i,j] / sum(lambda[i,]), 0.0), as.numeric(1)))
 ...
 n_S_E[,] <- if (j==1) Binomial(S[i] - n_ageoS[i] - n_muS[i], p_SE[i,j]) else
  ...
  # n_S_E[, 2:3] <- if (sum(rel_foi_strain[i, j:N_strain]) == 0) 0.0 else 
...
# n_R_tot[,] <- Binomial(R[i,j] - n_ageoR[i,j] - n_muR[i,j] - n_R_wane[i,j]-n_Rvacc[i,j], p_RE[i,j])  
  
  # n_R_progress[, , ] <- if (k == 1) Binomial(n_R_tot[i, j], rel_foi_strain[i, k]) else
  #   (if (k == 2 || k == 3) Binomial(n_R_tot[i, j] - sum(n_R_progress[i, j, 1:(k - 1)]),
  #                                   min(rel_foi_strain[i, k] / sum(rel_foi_strain[i,k:N_strain]), as.numeric(1))) else
  #                                     n_R_tot[i, j] - sum(n_R_progress[i, j, 1:3]))
 

  
  n_R_A[,1]  <- n_R_progress[i,1,1]
  ...
  n_R_E2[,3] <- n_R_progress[i,2,4]

  n_R_E3[,1] <- n_R_progress[i,3,1]
  n_R_E3[,2] <- n_R_progress[i,3,2]
  n_R_E3[,3] <- n_R_progress[i,3,4]
 
  n_R_E4[,1] <- n_R_progress[i,4,1]
  n_R_E4[,2] <- n_R_progress[i,4,2]
  n_R_E4[,3] <- n_R_progress[i,4,3]
...
dim(p_RE1) <- c(N_age,N_strain_1,N_strain)
  ...
  #n_R1_progress[, , ] <- if (sum(n_R1_tot[i, j, ]) > (R1[i,j] - n_ageoR1[i,j] - n_muR1[i,j] - n_R1_wane[i,j])) 
  #  round(n_R1_tot[i, j, k] * (R1[i,j] - n_ageoR1[i,j] - n_muR1[i,j] - n_R1_wane[i,j]) / sum(n_R1_tot[i, j, ])) else n_R1_tot[i, j, k]

  
  # n_R1_progress[, , ] <- if (k == 1) Binomial(n_R1_tot[i, j], rel_foi_strain[i, 1]) else
 ...
 p_RE2[,2,] <- p_RE[i,3,j]
 p_RE2[,3,] <- p_RE[i,4,j]
 dim(p_RE2) <- c(N_age,N_strain_1,N_strain)
  
  n_R2_progress[,,] <- if (k==1)Binomial(((R2[i, j] - n_ageoR2[i, j] - n_muR2[i, j] - n_R2_wane[i, j] ) ),p_RE2[i,j,k]) else
    Binomial((R2[i, j] - n_ageoR2[i, j] - n_muR2[i, j] - n_R2_wane[i, j]-sum(n_R2_progress[i,j,1:(k-1)])), p_RE2[i,j,k])

#   n_R2_progress[, , ] <- if (sum(n_R2_tot[i, j, ]) > (R2[i,j] - n_ageoR2[i,j] - n_muR2[i,j] - n_R2_wane[i,j])) 
#     round(n_R2_tot[i, j, k] * (R2[i,j] - n_ageoR2[i,j] - n_muR2[i,j] - n_R2_wane[i,j]) / sum(n_R2_tot[i, j, ])) else n_R2_tot[i, j, k]


  # n_R2_progress[, , ] <- if (k == 1) Binomial(n_R2_tot[i, j], rel_foi_strain[i, 1]) else
  #   (if (k == 2 || k == 3) Binomial(n_R2_tot[i, j] - sum(n_R2_progress[i, j, 1:(k - 1)]),
  #   min(rel_foi_strain[i, k] / sum(rel_foi_strain[i, k:N_strain]), as.numeric(1))) else
 ...
 p_RE3[,2,] <- p_RE[i,2,j]
 p_RE3[,3,] <- p_RE[i,4,j]
dim(p_RE3) <- c(N_age,N_strain_1,N_strain)
  
  n_R3_progress[,,] <- if (k==1) Binomial(((R3[i, j] - n_ageoR3[i, j] - n_muR3[i, j] - n_R3_wane[i, j] ) ),p_RE3[i,j,k]) else
    Binomial((R3[i, j] - n_ageoR3[i, j] - n_muR3[i, j] - n_R3_wane[i, j]-sum(n_R3_progress[i,j,1:(k-1)])), p_RE3[i,j,k])

#   n_R3_progress[, , ] <- if (sum(n_R3_tot[i, j, ]) > (R3[i,j] - n_ageoR3[i,j] - n_muR3[i,j] - n_R3_wane[i,j])) 
#     round(n_R3_tot[i, j, k] * (R3[i,j] - n_ageoR3[i,j] - n_muR3[i,j] - n_R3_wane[i,j]) / sum(n_R3_tot[i, j, ])) else n_R3_tot[i, j, k]

  # n_R3_progress[, , ] <- if (k == 1) Binomial(n_R3_tot[i, j], rel_foi_strain[i, 1]) else
  ...
  n_R3_A3[,3]   <- n_R3_progress[i,3,4]

  
  n_R3_E13[, 1] <- n_R3_progress[i,1,2 ]
  n_R3_E13[, 2] <- n_R3_progress[i,1,4 ]
  
  
  n_R3_E23[, 1] <- n_R3_progress[i,2,1]
  n_R3_E23[, 2] <- n_R3_progress[i,2,4]
 ...
 p_RE4[,2,] <- p_RE[i,2,j]
 p_RE4[,3,] <- p_RE[i,3,j]
 dim(p_RE4) <- c(N_age,N_strain_1,N_strain)
  ...
  n_R4_A4[,3]   <- n_R4_progress[i,3,3]
  
  n_R4_E14[, 1] <- n_R4_progress[i,1,2]
  n_R4_E14[, 2] <- n_R4_progress[i,1,3]

  n_R4_E24[, 1] <- n_R4_progress[i,2,1]
  n_R4_E24[, 2] <- n_R4_progress[i,2,3]
  
  n_R4_E34[,1]  <- n_R4_progress[i,3,1]
  n_R4_E34[,2]  <- n_R4_progress[i,3,2]
 ...
 dim(p_RE12) <- c(N_age,N_strain_2,N_strain)
  ...
  n_R12_E4rd[, 3] <- n_R12_progress[i,2,3]


  
  
  dim(n_R12_progress) <- c(N_age, N_strain_2,N_strain)
  dim(n_R13_progress) <- c(N_age, N_strain_2,N_strain)
  dim(n_R14_progress) <- c(N_age, N_strain_2,N_strain)
  dim(n_R23_progress) <- c(N_age, N_strain_2,N_strain)
  dim(n_R24_progress) <- c(N_age, N_strain_2,N_strain)
  ...
  n_R13vacc_c[, ] <- Binomial(R13[i, j] - n_ageoR13[i, j] - n_muR13[i, j]-  n_R13_wane[i,j], p_wane) 
 ...
 dim(p_RE13) <- c(N_age,N_strain_2,N_strain)
  ...
  n_R13_progress[,,] <- if (k==1)Binomial(((R13[i, j] - n_ageoR13[i, j] - n_muR13[i, j] - n_R13_wane[i, j] ) ), 
                             p_RE13[i,j,k]) else
  ...
  n_R13_E4rd[, 1] <- 0
  n_R13_E4rd[, 2] <- n_R13_progress[i,2, 2]
  n_R13_E4rd[, 3] <- 0
  n_R13_E4rd[, 4] <- n_R13_progress[i,1, 4]  
  
  ########## Transitions R14 (not 1 and 4, j 2 and 3) 
  
  n_R14_wane[, ] <- Binomial(R14[i, j] - n_ageoR14[i, j] - n_muR14[i, j], p_wane)
  
  n_R14vacc_c[, ] <- Binomial(R14[i, j] - n_ageoR14[i, j] - n_muR14[i, j]-n_R14_wane[i,j], p_wane)
...
#     min(rel_foi_strain[i,  k] / sum(rel_foi_strain[i, k:N_strain]), as.numeric(1))) else
#       n_R14_tot[i, j] - sum(n_R14_progress[i, j, 1:3]))


  # reinfection from same strain
  n_R14_A14[,1]   <- n_R14_progress[i,1,2]
  n_R14_A14[,2]   <- n_R14_progress[i,2,3] 
  

  n_R14_E4rd[, 1] <- 0
  n_R14_E4rd[, 2] <- n_R14_progress[i,2, 2]
  n_R14_E4rd[, 3] <- n_R14_progress[i,1, 3]
  n_R14_E4rd[, 4] <- 0
  ...
  n_R23vacc_c[, ] <- Binomial(R23[i, j] - n_ageoR23[i, j] - n_muR23[i, j]-  n_R23_wane[i,j], p_wane)
 ...
 n_R23_progress[, , ] <- if (k==1)Binomial(((R23[i, j] - n_ageoR23[i, j] - n_muR23[i, j] - n_R23_wane[i, j] ) ), 
  ...
  n_R23_E4rd[, 1] <- n_R23_progress[i,2, 1]
   n_R23_E4rd[, 2] <- 0
   n_R23_E4rd[, 3] <- 0
  n_R23_E4rd[, 4] <- n_R23_progress[i,1, 4]
  
  ########## Transitions R24 (not 2 and 4, j 1 and 3) 
  
  n_R24_wane[, ] <- Binomial(R24[i, j] - n_ageoR24[i, j] - n_muR24[i, j], p_wane)
  
  n_R24vacc_c[, ] <- Binomial(R24[i, j] - n_ageoR24[i, j] - n_muR24[i, j]-n_R24_wane[i,j], p_wane)
 ...
 p_RE24[,1,] <- p_RE[i,1,j]
  ...
  dim(p_RE24) <- c(N_age,N_strain_2,N_strain)
   ...
   Binomial((R24[i, j] - n_ageoR24[i, j] - n_muR24[i, j] - n_R24_wane[i, j]-sum(n_R24_progress[i,j,1:(k-1)])), p_RE24[i,j,k])
      ...
      #     min(rel_foi_strain[i, k] / sum(rel_foi_strain[i, k:N_strain]), as.numeric(1))) else
      #       n_R24_tot[i, j] - sum(n_R24_progress[i, j, 1:3]))


  # Reinfection with same strain
  n_R24_A24[,1]   <- n_R24_progress[i,1,1]
  n_R24_A24[,2]   <- n_R24_progress[i,2,3]
  
  
  n_R24_E4rd[, 1] <- n_R24_progress[i,2, 1]
  n_R24_E4rd[, 2] <- 0
  n_R24_E4rd[, 3] <- n_R24_progress[i,1, 3]  
  n_R24_E4rd[, 4] <- 0
  ...
  n_R34vacc_c[, ] <- Binomial(R34[i, j] - n_ageoR34[i, j] - n_muR34[i, j]-n_R34_wane[i,j], p_wane)
...
#  n_R34_progress[, , ] <- if (k == 1) Binomial(n_R34_tot[i, j], rel_foi_strain[i, 1]) else
...
#       n_R34_tot[i, j] - sum(n_R34_progress[i, j, 1:3]))
  ...
  n_R4rdvacc_c[, ] <- Binomial(R4rd[i, j] - n_ageoR4rd[i, j] - n_muR4rd[i, j]-  n_R4rd_wane[i,j], p_wane)  
...
#     (if (k == 2 || k == 3) Binomial(n_R4rd_tot[i, j] - sum(n_R4rd_progress[i, j, 1:(k - 1)]),
#     min(rel_foi_strain[i, k] / sum(rel_foi_strain[i, k:N_strain]), as.numeric(1))) else
#       n_R4rd_tot[i, j] - sum(n_R4rd_progress[i, j, 1:3]))
 

  
  # reinfections from same strain
  n_R4rd_A4rd[, ] <-  sum(n_R4rd_progress[i,,j])
  ...
  n_reinf_A1[,1]<- n_R2_progress[i,1,2]
  n_reinf_A1[,2]<- n_R3_progress[i,1,3]
  n_reinf_A1[,3]<- n_R4_progress[i,1,4]
  
  n_reinf_A2[,1]<- n_R1_progress[i,1,1]
  n_reinf_A2[,2]<- n_R3_progress[i,2,3]
  n_reinf_A2[,3]<- n_R4_progress[i,2,4]
  
  n_reinf_A3[,1]<- n_R1_progress[i,2,1]
  n_reinf_A3[,2]<- n_R2_progress[i,2,2]
  n_reinf_A3[,3]<- n_R4_progress[i,3,4]
  
  n_reinf_A4[,1]<- n_R1_progress[i,3,1]
  n_reinf_A4[,2]<- n_R2_progress[i,3,2]
  n_reinf_A4[,3]<- n_R3_progress[i,3,3]
  
  n_reinf_A12[,1] <- n_R23_progress[i,1,3]+n_R13_progress[i,1,3]
  n_reinf_A12[,2] <- n_R24_progress[i,1,4]+n_R14_progress[i,1,4]
  
  
  n_reinf_A13[,1] <- n_R23_progress[i,1,2]+n_R12_progress[i,1,2]
  n_reinf_A13[,2] <- n_R14_progress[i,2,4]+n_R34_progress[i,1,4]
  
  n_reinf_A14[,1] <- n_R12_progress[i,2,2]+n_R24_progress[i,1,2]
  n_reinf_A14[,2] <- n_R34_progress[i,1,3]+n_R13_progress[i,2,3]
  
  n_reinf_A23[,1] <- n_R13_progress[i,1,1]+n_R12_progress[i,1,1]
  n_reinf_A23[,2] <- n_R34_progress[i,2,4]+n_R24_progress[i,2,4]
  
  n_reinf_A24[,1] <- n_R14_progress[i,1,1]+n_R12_progress[i,2,1]
  n_reinf_A24[,2] <- n_R34_progress[i,2,3]+n_R23_progress[i,2,3]
...
dim(wane_jumpR4rd_4)  <- c(N_age, N_strain_1)
  ...
  n_bG[] <- if (i==1) Binomial(n_allDeath, p_nonsecretor) else 0.0 
  n_bM[] <- if (i==1) Binomial(n_allDeath - n_bG[1], (1-p_nonsecretor)*(prev+1e-12)) else 0.0
  ...
  factor_beta_1 <- parameter()
  factor_beta_2 <- parameter()
  log_beta_3 <- parameter()
  factor_beta_4 <- parameter()
  ...
  beta_1 <- beta_3 * factor_beta_1
  beta_2 <- beta_3 * factor_beta_2
  beta_4 <- beta_3 * factor_beta_4
  maternalAB <-exp(log_maternalAB)  
  aduRR  <- exp(log_aduRR)
  repfac_65p <- exp(log_repfac_65p)            # reference group (lowest underreporting)
  repfac_0   <- repfac_65p * exp(log_ratio_0)    # ~2.7x higher than elderly
  repfac_5   <- repfac_65p * exp(log_ratio_5)    # ~28x higher than elderly
  repfac_15  <- repfac_65p * exp(log_ratio_15)  # ~2.9x higher than elderly
