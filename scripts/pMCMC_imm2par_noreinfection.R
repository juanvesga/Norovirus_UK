...
if (start_from_best){
  ...
  rm(processed_chains)
  # last_best2<-xvals$x
  # names(last_best)<-names(scaling_fac)
  # # 
  ...
  priors <- list(
    ...
    # mcstate::pmcmc_parameter("w2",
    #                          initial= last_best[["w2"]],#0.1*scaling_fac[["w1_2"]], # Seasonality amplitude
    #                          min = 0.1*scaling_fac[["w2"]], max = 4*scaling_fac[["w2"]]),
    # 
  ...
  priors <- list(
    mcstate::pmcmc_parameter("beta_1",
                             initial=   0.2022*scaling_fac[["beta_1"]], # Transmission per capita
                             min = 0*scaling_fac[["beta_1"]]),
    mcstate::pmcmc_parameter("beta_2",
                             initial=  0.22423*scaling_fac[["beta_2"]], # Transmission per capita
                             min = 0*scaling_fac[["beta_2"]]),
    
    mcstate::pmcmc_parameter("beta_3",
                             initial=  0.6073*scaling_fac[["beta_3"]], # Transmission per capita
                             min = 0*scaling_fac[["beta_3"]]),
    mcstate::pmcmc_parameter("beta_4",
                             initial= 0.4673*scaling_fac[["beta_4"]], # Transmission per capita
                             min = 0*scaling_fac[["beta_4"]]),
    ...
    mcstate::pmcmc_parameter("maternalAB",
                             initial=  80 *scaling_fac[["maternalAB"]], # Duration of maternal Abs
                             min = 1*scaling_fac[["maternalAB"]], max = 365*scaling_fac[["maternalAB"]] ),
    ...
    mcstate::pmcmc_parameter("imm_fac",
                             initial=  2.14197509*scaling_fac[["imm_fac"]], # Duration of immunity
                             min = 1*scaling_fac[["imm_fac"]] ),
    ...
    # mcstate::pmcmc_parameter("w2",
    #                          initial=  3*scaling_fac[["w2"]], # Seasonality amplitude
    #                          min = 0.1*scaling_fac[["w2"]], max = 4*scaling_fac[["w2"]]),
