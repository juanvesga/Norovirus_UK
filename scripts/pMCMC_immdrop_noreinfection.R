...
if (start_from_best){
  ...
  priors <- list(
    ...
    mcstate::pmcmc_parameter("imm_yr",
                             ...
                             min = 0.5*scaling_fac[["imm_yr"]], max = 70*scaling_fac[["imm_yr"]] ),
  ...
  priors <- list(
    mcstate::pmcmc_parameter("beta_1",
                             initial=   0.31352660*scaling_fac[["beta_1"]], # Transmission per capita
                             min = 0*scaling_fac[["beta_1"]]),
    mcstate::pmcmc_parameter("beta_2",
                             initial=  0.33105375*scaling_fac[["beta_2"]], # Transmission per capita
                             min = 0*scaling_fac[["beta_2"]]),
    
    mcstate::pmcmc_parameter("beta_3",
                             initial=     1.13875197 *scaling_fac[["beta_3"]], # Transmission per capita
                             min = 0*scaling_fac[["beta_3"]]),
    mcstate::pmcmc_parameter("beta_4",
                             initial=   0.70062135*scaling_fac[["beta_4"]], # Transmission per capita
                             min = 0*scaling_fac[["beta_4"]]),
    
    mcstate::pmcmc_parameter("aduRR",
                             initial=   0.08377272 *scaling_fac[["aduRR"]], # Excess infectiousness in Und 5
                             min = 0*scaling_fac[["aduRR"]], max = 1*scaling_fac[["aduRR"]]),
    
    mcstate::pmcmc_parameter("maternalAB",
                             initial=   81.59086447  *scaling_fac[["maternalAB"]], # Duration of maternal Abs
                             min = 1*scaling_fac[["maternalAB"]], max = 365*scaling_fac[["maternalAB"]] ),
    
    
    mcstate::pmcmc_parameter("imm_yr",
                             initial= 19.61791224  *scaling_fac[["imm_yr"]], # Duration of immunity
                             min = 0.5*scaling_fac[["imm_yr"]], max = 70*scaling_fac[["imm_yr"]] ),
    
    mcstate::pmcmc_parameter("imm_fac",
                             initial=    2.11062235*scaling_fac[["imm_fac"]], # Duration of immunity
                             min = 1*scaling_fac[["imm_fac"]] ),
    
    mcstate::pmcmc_parameter("w1_1",
                             initial=     0.31567480*scaling_fac[["w1_1"]], # Seasonality amplitude
                             min = 0.05*scaling_fac[["w1_1"]], max = 0.5*scaling_fac[["w1_1"]]),
    
    
    mcstate::pmcmc_parameter("repfac_0",
                             initial= 159.98810378 *scaling_fac[["repfac_0"]], # Seasonality amplitude
                             min = 1*scaling_fac[["repfac_0"]], max = 2000*scaling_fac[["repfac_0"]]),
    
    mcstate::pmcmc_parameter("repfac_5",
                             initial= 510.00000000 *scaling_fac[["repfac_5"]], # Seasonality amplitude
                             min = 1*scaling_fac[["repfac_5"]], max = 2000*scaling_fac[["repfac_5"]]),
    
    mcstate::pmcmc_parameter("repfac_15",
                             initial= 480.00000000 *scaling_fac[["repfac_15"]], # Seasonality amplitude
                             min = 1*scaling_fac[["repfac_15"]], max = 2000*scaling_fac[["repfac_15"]]),
    
    mcstate::pmcmc_parameter("repfac_65p",
                             initial=  40.00000000*scaling_fac[["repfac_65p"]], # Seasonality amplitude
                             min = 1*scaling_fac[["repfac_65p"]], max = 2000*scaling_fac[["repfac_65p"]]),
    
    
    mcstate::pmcmc_parameter("crossp_12",
                             initial= 0.04876855*scaling_fac[["crossp_12"]], # Duration of maternal Abs
                             min = 0*scaling_fac[["crossp_12"]],max = 1*scaling_fac[["crossp_12"]]),
    
    mcstate::pmcmc_parameter("crossp_21",
                             initial=  0.05012397 *scaling_fac[["crossp_21"]], # Duration of maternal Abs
                             min = 0*scaling_fac[["crossp_21"]],max = 1*scaling_fac[["crossp_21"]]),
    
    mcstate::pmcmc_parameter("crossp_34",
                             initial=   0.05404153  *scaling_fac[["crossp_34"]], # Duration of maternal Abs
                             min = 0*scaling_fac[["crossp_34"]],max = 1*scaling_fac[["crossp_34"]]),
    
    mcstate::pmcmc_parameter("crossp_43",
                             initial=  0.05126302*scaling_fac[["crossp_43"]], # Duration of maternal Abs
                             min = 0*scaling_fac[["crossp_43"]],max = 1*scaling_fac[["crossp_43"]]))
